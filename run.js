...
// Sistem blocare pin aplicatii in Action Center - START


var countPinnedTagsVariable = 0;

function countPinnedTags(){
  return countPinnedTagsVariable = 1 + countPinnedTagsVariable;
}

function countPinnedTags1(){
  return countPinnedTagsVariable = 1 + countPinnedTagsVariable;
}
...
// Sistem blocare pin aplicatii in Action Center - END
